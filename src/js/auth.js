...
(function() {
    ...
    function createAuthModal() {
        ...
        modal.innerHTML = `
            ...
            <div class="auth-container" role="dialog" aria-labelledby="auth-title">
                ...
                <div class="auth-header-section">
                    ...
                    <p class="auth-subtitle">Sign in to sync your reading progress across devices</p>
                </div>
                ...
                <div class="auth-body">
                    ...
                    <form id="auth-email-form" class="auth-form">
                        ...
                        <div class="auth-field">
                            ...
                            <input type="password" id="auth-password" placeholder="Min. 6 characters" required autocomplete="current-password" minlength="6">
                        </div>
                ...
                <div class="auth-footer">
                    ...
                    Progress syncs with <a href="https://superdebate.org" target="_blank">superdebate.org</a>
                </div>
            </div>
        `;
        ...
        modal.querySelectorAll('.auth-tab').forEach(tab => {
            tab.addEventListener('click', (e) => {
                ...
                modal.querySelector('#auth-submit-btn').textContent = isSignup ? 'Create Account' : 'Sign In';
                modal.querySelector('#auth-title').textContent = isSignup ? 'Get Started' : 'Welcome';
                modal.querySelector('.auth-subtitle').textContent = isSignup
                ...
                modal.querySelector('#auth-password').placeholder = isSignup ? 'Create a password (min. 6 chars)' : 'Min. 6 characters';
            });
        });
    ...
    function closeAuthModal() {
        ...
        // Clear form and reset to Sign In state
        ...
        authModal.querySelector('[data-tab="signin"]').classList.add('active');
        authModal.querySelector('#auth-submit-btn').textContent = 'Sign In';
        authModal.querySelector('#auth-title').textContent = 'Welcome';
        authModal.querySelector('.auth-subtitle').textContent = 'Sign in to sync your reading progress across devices';
        authModal.querySelector('#auth-password').autocomplete = 'current-password';
        authModal.querySelector('#auth-password').placeholder = 'Min. 6 characters';
    }
    ...
    function showAuthError(message, isSuccess) {
        ...
        errorEl.classList.toggle('auth-success', !!isSuccess);
    }
